...
if [ -z "$NEEDS_TAG" ]; then
    ...
    git push --tags refs/remotes/* -u abhinavvashishat https://abhinavvashishat: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@github.com/abhinavvashishat/lakeshore.git origin  
else
