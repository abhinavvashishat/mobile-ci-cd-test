...
if [ -z "$NEEDS_TAG" ]; then
    ...
    git push --force https://abhinavvashishat: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@github.com/abhinavvashishat/lakeshore.git refs/remotes/origin/* HEAD:master
else
