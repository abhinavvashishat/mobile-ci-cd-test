...
if [ -z "$NEEDS_TAG" ]; then
    ...
    git push https://abhinavvashishat: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@github.com/abhinavvashishat/react-native-starter.git refs/remotes/origin/  $NEW_TAG 
else
